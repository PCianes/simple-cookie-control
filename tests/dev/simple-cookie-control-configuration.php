 ...
 * @subpackage Simple_Cookie_Control/tests/dev
 */
			  ...
			  <ul>
				  ...
				  <li>- Type <code>into the console</code> base in the root of the project if you already run "npm install" & "composer install":</li>
					<ol>
						...
						<li><code>grunt</code> to make auto the simple-cookie-control.pot into the languages folder, and <code>grunt watch</code> to make min files of CSS & JS. -->Stop with: <code>Ctrl + C</code></li>
						...
						<li><code>php make class CLASS-NAME FOLDER-NAME</code> to create a new file into the FOLDER-NAME indicate with the name: class-simple-cookie-control-CLASS-NAME.php with some base code to start to work.</li>
...
function plugin_name_render_admin_bar_css() {
	...
	include 'simple-cookie-control-bar-dev.php';
