 ...
 */
class Simple_Cookie_Control_Loader {
	 ...
	 * @since 	1.0.0
	 * @access private
	 * @var object		Simple_Cookie_Control_Loader
	 */
	...
	*/
	 ...
	 *
	 * Usage Simple_Cookie_Control_Loader::get_instance()->remove( $hook, $component, $callback );
	 *
	 * @since      1.0.0
	 * @param      string               $hook             The name of the WordPress filter that is being registered.
	 * @param      object               $component        A reference to the instance of the object on which the filter is defined.
	...
	protected function hook_index( $hook, $component, $callback ) {
		$component_name = ! empty( $component ) ? get_class( $component ) : 'Simple_Cookie_Control';
	 ...
	 *
	 * @since 			1.0.0
	 * @return object 	Simple_Cookie_Control_Loader
	 */
	public static function get_instance() {
		if( is_null( self::$instance ) ) {
			self::$instance = new Simple_Cookie_Control_Loader();
		}
