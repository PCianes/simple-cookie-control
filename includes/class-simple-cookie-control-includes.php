 ...
 */
class Simple_Cookie_Control_Includes {
	...
	private function load_dependencies() {
		 ...
		 * example: require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-simple-cookie-control-class-name.php';
		 * example: $class_name = new Simple_Cookie_Control_Class_Name( $this->get_plugin_name(), $this->get_version() );
		 */
	}
